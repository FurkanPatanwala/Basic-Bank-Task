    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto justify-content-end">
          ...
          <li class="nav-item">
            <a style="color: #6495ED; font-size: 25px; margin-left: 40px;"class="nav-link" href="transacthistory.php">CONTACT</a>
          </li>
        </ul> 
      </div>
    </div>
     ...
     <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:350px;" src="AboutUs.PNG" alt="TSF Bank">
        </div>
...
<footer>
	<p class="text-copy">
      Copyright &copy; By Furkan Patanwala
    </p>
</footer>
